  ...
  return (
    <div className="h-screen overflow-hidden bg-[#070b12] text-white">
      ...
      <div className="flex h-full">
        <aside className="relative hidden md:flex md:w-64 lg:w-72 shrink-0 sticky top-0 h-screen overflow-y-auto flex-col border-r border-white/10 bg-[linear-gradient(180deg,rgba(26,115,232,0.14),rgba(26,115,232,0)_24%),#040507]">
            ...
            <div className="sidebar-aura-card rounded-2xl px-3 py-3 border border-white/10 bg-white/[0.03]">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[11px] uppercase tracking-[0.12em] text-gray-500">Developer</p>
                </div>
              </div>
              <button
